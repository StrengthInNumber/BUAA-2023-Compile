...
public class SymbolVar extends Symbol {
    ...
    private int initVal_0; //初值
    private ArrayList<Integer> initVal_1; //一位数组初值
    private ArrayList<ArrayList<Integer>> initVal_2; //一位数组初值

    public SymbolVar(int lineNum, String name, int dim, ValueType type, ArrayList<Integer> lengths) {
